...
from techpilot.safety.trust import WorkspaceTrustStore, confirm_workspace_access
...
def test_workspace_trust_gate_accepts_enter_and_shows_canonical_path(tmp_path):
    ...
    assert "TechPilot will be able to read, edit, and execute files here." in rendered
