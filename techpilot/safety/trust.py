...
class WorkspaceTrustStore:
    ...
    def __init__(self, path: Path | None = None) -> None:
        self.path = (path or (Path.home() / ".techpilot" / "trusted_workspaces.json")).expanduser()
...
def confirm_workspace_access(
    ...
    *,
    ...
    body.append(
        "TechPilot will be able to read, edit, and execute files here.",
        style="white",
    )
    console.print(
        Panel(
    ...
    while True:
        ...
        if normalized in {"", "1", "y", "yes"}:
            ...
            # begins with the TechPilot welcome panel; StringIO-based
