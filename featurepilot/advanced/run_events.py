"""Append-only execution trace for one FeaturePilot Managed Run."""
...
from featurepilot.engine.events import EventSink, RuntimeEvent
...
class RunEventLog:
    ...
    def record(self, event_type: str, payload: dict[str, Any] | None = None) -> None:
        """Append one FeaturePilot orchestration fact for this Run."""
