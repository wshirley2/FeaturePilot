...
from featurepilot.engine.agent import Agent, ToolExecutor
from featurepilot.engine.config import Config, default_context_tokens_for_model
from featurepilot.engine.events import EventSink
from featurepilot.engine.llm import LLM, LiteLLM
from featurepilot.engine.permissions import DenyPermissionPrompt, PermissionManager, PermissionPrompt
...
class TaskRuntime:
    ...
    def set_model(self, model: str, *, record: bool = True) -> None:
        ...
        if "FEATUREPILOT_MAX_CONTEXT" not in os.environ:
